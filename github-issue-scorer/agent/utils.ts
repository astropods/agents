...
export const VALID_SENTIMENTS = new Set<string>([
  "frustration",
  "urgency",
  "neutral",
  "positive",
...
export function normalizeAnalysis(raw: unknown): IssueAnalysis {
  ...
  return {
    ...
    sentiment,
    sentiment_details:
      typeof obj.sentiment_details === "string" ? obj.sentiment_details : "",
    competitive_mentions: Array.isArray(obj.competitive_mentions)
      ? obj.competitive_mentions.filter(
    ...
    priority,
    priority_reason:
      typeof obj.priority_reason === "string" ? obj.priority_reason : "",
  };
}
